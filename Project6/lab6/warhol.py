...
if __name__ == '__main__':
    ...
    canvas = gr.Image(gr.Point(0,0),(myImage.getWidth())*2, (myImage.getHeight())*2)
    imageList = [[0, 0, 'original', myImage],[myImage.getWidth(), 0, 'swapGreenBlue', myImage],[0, myImage.getHeight(), 'accentuateRed', myImage],[myImage.getWidth(), myImage.getHeight(), 'blackWhite', myImage]]
    for i in imageList:
        print(type(i[3]))
        cImage=i[3].clone()
